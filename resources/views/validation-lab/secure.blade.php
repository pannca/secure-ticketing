                        ...
                        <form action="{{ route('validation-lab.secure.submit') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="name" id="name"
                                    ...
                                    required minlength="2" maxlength="100" placeholder="Masukkan nama">
                                @error('name')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" name="age" id="age"
                                    ...
                                    required min="17" max="100" placeholder="Masukkan umur">
                                @error('age')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <small class="text-muted">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="message" id="message" class="form-control @error('message') is-invalid @enderror" required
                                    minlength="10" maxlength="1000" rows="3" placeholder="Tulis pesan Anda...">{{ old('message') }}</textarea>
                                @error('message')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <small class="text-muted">
