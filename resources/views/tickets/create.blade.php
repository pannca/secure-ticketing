                    ...
                    <form action="{{ route('tickets.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="title" id="title"
                                ...
                                placeholder="Masukkan judul tiket" required maxlength="255">
                            @error('title')
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="description" id="description" class="form-control @error('description') is-invalid @enderror"
                                rows="5" placeholder="Jelaskan masalah Anda secara detail..." required minlength="10">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
